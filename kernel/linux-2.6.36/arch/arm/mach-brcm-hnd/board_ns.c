...
#ifdef CONFIG_XIAOMI_R1D
#define FLASH_PARTS_NUM	10
#else
...
init_mtd_partitions(hndsflash_t *sfl_info, struct mtd_info *mtd, size_t size)
{
...
#else
	bcm947xx_flash_parts[nparts].name = "boot";
	bcm947xx_flash_parts[nparts].size = 0x40000;
	bcm947xx_flash_parts[nparts].offset = 0x0;
	bcm947xx_flash_parts[nparts].mask_flags = MTD_WRITEABLE;
	nparts++;

	bcm947xx_flash_parts[nparts].name = "os";
	bcm947xx_flash_parts[nparts].size = 0x300000;
	bcm947xx_flash_parts[nparts].offset = 0x40000;
	nparts++;

	bcm947xx_flash_parts[nparts].name = "os1";
	bcm947xx_flash_parts[nparts].size = 0x300000;
	bcm947xx_flash_parts[nparts].offset = 0x340000;
	nparts++;

	bcm947xx_flash_parts[nparts].name = "squashfs";
	bcm947xx_flash_parts[nparts].size = 0x890000;
	bcm947xx_flash_parts[nparts].offset = 0x640000;
	bcm947xx_flash_parts[nparts].mask_flags = MTD_WRITEABLE;
	nparts++;

	bcm947xx_flash_parts[nparts].name = "crash";
	bcm947xx_flash_parts[nparts].size = 0x10000;
	bcm947xx_flash_parts[nparts].offset = 0xed0000;
	nparts++;

	bcm947xx_flash_parts[nparts].name = "overlay";
	bcm947xx_flash_parts[nparts].size = 0x100000;
	bcm947xx_flash_parts[nparts].offset = 0xee0000;
	nparts++;
	...
	bcm947xx_flash_parts[nparts].name = "firmware";
	bcm947xx_flash_parts[nparts].size = 0xfe0000;
	bcm947xx_flash_parts[nparts].offset = 0x0;
#endif
