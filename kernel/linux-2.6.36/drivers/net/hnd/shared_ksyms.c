...
extern void hnd_cpu_jumpto; EXPORT_SYMBOL(hnd_cpu_jumpto);
extern void hnd_cpu_reset; EXPORT_SYMBOL(hnd_cpu_reset);
extern void si_arm_init; EXPORT_SYMBOL(si_arm_init);
extern void si_arm_setclock; EXPORT_SYMBOL(si_arm_setclock);
extern void si_cpu_clock; EXPORT_SYMBOL(si_cpu_clock);
extern void si_irq; EXPORT_SYMBOL(si_irq);
extern void si_mem_clock; EXPORT_SYMBOL(si_mem_clock);
extern void si_mem_setclock; EXPORT_SYMBOL(si_mem_setclock);
extern void hnd_jtagm_disable; EXPORT_SYMBOL(hnd_jtagm_disable);
extern void hnd_jtagm_init; EXPORT_SYMBOL(hnd_jtagm_init);
extern void jtag_scan; EXPORT_SYMBOL(jtag_scan);
extern void si_cc_isr; EXPORT_SYMBOL(si_cc_isr);
extern void si_cc_register_isr; EXPORT_SYMBOL(si_cc_register_isr);
extern void si_serial_init; EXPORT_SYMBOL(si_serial_init);
...
extern void extpci_read_config; EXPORT_SYMBOL(extpci_read_config);
extern void extpci_write_config; EXPORT_SYMBOL(extpci_write_config);
extern void hndpci_arb_park; EXPORT_SYMBOL(hndpci_arb_park);
extern void hndpci_ban; EXPORT_SYMBOL(hndpci_ban);
extern void hndpci_deinit; EXPORT_SYMBOL(hndpci_deinit);
extern void hndpci_deinit_pci; EXPORT_SYMBOL(hndpci_deinit_pci);
extern void hndpci_find_pci_capability; EXPORT_SYMBOL(hndpci_find_pci_capability);
extern void hndpci_get_membase; EXPORT_SYMBOL(hndpci_get_membase);
extern void hndpci_init; EXPORT_SYMBOL(hndpci_init);
extern void hndpci_init_cores; EXPORT_SYMBOL(hndpci_init_cores);
extern void hndpci_init_pci; EXPORT_SYMBOL(hndpci_init_pci);
extern void hndpci_is_hostbridge; EXPORT_SYMBOL(hndpci_is_hostbridge);
extern void hndpci_read_config; EXPORT_SYMBOL(hndpci_read_config);
extern void hndpci_write_config; EXPORT_SYMBOL(hndpci_write_config);
...
extern void hndsflash_commit; EXPORT_SYMBOL(hndsflash_commit);
extern void hndsflash_erase; EXPORT_SYMBOL(hndsflash_erase);
extern void hndsflash_init; EXPORT_SYMBOL(hndsflash_init);
extern void hndsflash_poll; EXPORT_SYMBOL(hndsflash_poll);
extern void hndsflash_read; EXPORT_SYMBOL(hndsflash_read);
extern void hndsflash_write; EXPORT_SYMBOL(hndsflash_write);
extern void soc_boot_dev; EXPORT_SYMBOL(soc_boot_dev);
extern void soc_knl_dev; EXPORT_SYMBOL(soc_knl_dev);
...
extern void _nvram_commit; EXPORT_SYMBOL(_nvram_commit);
extern void _nvram_exit; EXPORT_SYMBOL(_nvram_exit);
extern void _nvram_get; EXPORT_SYMBOL(_nvram_get);
extern void _nvram_getall; EXPORT_SYMBOL(_nvram_getall);
extern void _nvram_init; EXPORT_SYMBOL(_nvram_init);
extern void _nvram_set; EXPORT_SYMBOL(_nvram_set);
extern void _nvram_unset; EXPORT_SYMBOL(_nvram_unset);
extern void curr_nvram_hash; EXPORT_SYMBOL(curr_nvram_hash);
extern void nvram_calc_crc; EXPORT_SYMBOL(nvram_calc_crc);
...
extern void spiflash_init; EXPORT_SYMBOL(spiflash_init);
